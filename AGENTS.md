...
Persistent, repo-level notes for any coding agent/extension (Codex,
...
- **Full details / S3 SDK usage / DaVinciOS `media` collection integration:**
  see [`.Codex/skills/digitalocean-spaces/SKILL.md`](.Codex/skills/digitalocean-spaces/SKILL.md)
...
It is currently registered for **Codex** (`Codex mcp add do-spaces -s
local ...`, scoped to this project in `~/.Codex.json`), read-only
