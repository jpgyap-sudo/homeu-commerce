  ...
  return (
    <div style={{ maxWidth: 600 }}>
      ...
      <div style={{
        ...
        <SettingsField label="Region" fieldKey="doSpacesRegion" type="text" value={config.doSpacesRegion || ''} onChange={(k, v) => setConfig(prev => ({ ...prev, [k]: v }))} placeholder="sgp1" hint="DO Spaces region slug — used to build the upload endpoint" />
