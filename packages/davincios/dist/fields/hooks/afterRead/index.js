 ...
 */ export async function afterRead(args) {
    ...
    let depth = incomingDepth || incomingDepth === 0 ? parseInt(String(incomingDepth), 10) : req.DaVinciOS.config.defaultDepth;
    if (depth > req.DaVinciOS.config.maxDepth) {
        depth = req.DaVinciOS.config.maxDepth;
    }
