                    ...
                    if (Array.isArray(field.relationTo)) {
                        if (Array.isArray(value)) {
                            value.forEach((relatedDoc, i)=>{
                                const relatedCollection = req.DaVinciOS.collections?.[relatedDoc.relationTo]?.config;
                        ...
                        if (field.hasMany !== true && valueIsValueWithRelation(value)) {
                            const relatedCollection = req.DaVinciOS.collections?.[value.relationTo]?.config;
                        ...
                        if (Array.isArray(value)) {
                            value.forEach((relatedDoc, i)=>{
                                const relatedCollection = Array.isArray(field.relationTo) ? undefined : req.DaVinciOS.collections?.[field.relationTo]?.config;
                        ...
                        if (field.hasMany !== true && value) {
                            const relatedCollection = req.DaVinciOS.collections?.[field.relationTo]?.config;
        ...
        case 'blocks':
            {
                ...
                if (Array.isArray(rows)) {
                    ...
                    rows.forEach((row, rowIndex)=>{
                        ...
                        const block = req.DaVinciOS.blocks[blockTypeToMatch] ?? (field.blockReferences ?? field.blocks).find((curBlock)=>typeof curBlock !== 'string' && curBlock.slug === blockTypeToMatch);
                        if (block) {
                            ;
