...
export async function up(args) {
    const { collectionSlug, db, globalSlug, DaVinciOS, req, sql } = args;
    ...
    if (!localesTableExists) {
      ...
      `
        ...
        const versionLocaleStatus = calculateVersionLocaleStatuses(versionsResult.rows, existingLocales, DaVinciOS);
