 ...
 */
export interface DaVinciOSTypesShape {
 ...
 */
export interface UntypedDaVinciOSTypes {
    auth: {
        [slug: string]: {
            forgotPassword: {
                email: string;
 ...
 */
export type DaVinciOSTypes = IsAugmented extends true ? GeneratedTypes & Omit<UntypedDaVinciOSTypes, keyof GeneratedTypes> : UntypedDaVinciOSTypes;
export type TypedCollection<T extends DaVinciOSTypesShape = DaVinciOSTypes> = T['collections'];
export type TypedBlock = DaVinciOSTypes['blocks'];
export type TypedWidget<T extends DaVinciOSTypesShape = DaVinciOSTypes> = T extends {
    widgets: infer TWidgets;
} ? TWidgets extends Record<string, unknown> ? TWidgets : Record<string, unknown> : Record<string, unknown>;
export type TypedUploadCollection<T extends DaVinciOSTypesShape = DaVinciOSTypes> = NonNever<{
    [TSlug in keyof T['collections']]: 'filename' | 'filesize' | 'mimeType' | 'url' extends keyof T['collections'][TSlug] ? T['collections'][TSlug] : never;
}>;
export type TypedCollectionSelect<T extends DaVinciOSTypesShape = DaVinciOSTypes> = T['collectionsSelect'];
export type TypedCollectionJoins<T extends DaVinciOSTypesShape = DaVinciOSTypes> = T['collectionsJoins'];
export type TypedGlobal<T extends DaVinciOSTypesShape = DaVinciOSTypes> = T['globals'];
export type TypedGlobalSelect<T extends DaVinciOSTypesShape = DaVinciOSTypes> = T['globalsSelect'];
export type StringKeyOf<T> = Extract<keyof T, string>;
export type CollectionSlug<T extends DaVinciOSTypesShape = DaVinciOSTypes> = StringKeyOf<T['collections']>;
export type BlockSlug = StringKeyOf<TypedBlock>;
export type WidgetSlug<T extends DaVinciOSTypesShape = DaVinciOSTypes> = StringKeyOf<TypedWidget<T>>;
export type DataFromWidgetSlug<TSlug extends WidgetSlug> = TypedWidget[TSlug] extends {
    data?: infer TData;
} ? TData : TypedWidget[TSlug];
export type UploadCollectionSlug<T extends DaVinciOSTypesShape = DaVinciOSTypes> = StringKeyOf<TypedUploadCollection<T>>;
export type DefaultDocumentIDType = DaVinciOSTypes['db']['defaultIDType'];
export type GlobalSlug<T extends DaVinciOSTypesShape = DaVinciOSTypes> = StringKeyOf<T['globals']>;
export type TypedLocale<T extends DaVinciOSTypesShape = DaVinciOSTypes> = T['locale'];
export type TypedFallbackLocale = DaVinciOSTypes['fallbackLocale'];
/**
 *
 ...
 */
export type TypedUser = DaVinciOSTypes['user'];
export type TypedAuthOperations<T extends DaVinciOSTypesShape = DaVinciOSTypes> = T['auth'];
export type AuthCollectionSlug<T extends DaVinciOSTypesShape = DaVinciOSTypes> = StringKeyOf<T['auth']>;
export type TypedJobs = DaVinciOSTypes['jobs'];
 ...
 */
export type Job<TWorkflowSlugOrInput extends false | keyof TypedJobs['workflows'] | object = false> = HasDaVinciOSJobsType extends true ? {
 ...
 */
export declare class BaseDaVinciOS {
    /**
    ...
    jobs: {
        handleSchedules: (args?: {
            allQueues?: boolean;
            queue?: string;
            req?: import("./types/index.js").DaVinciOSRequest;
...
export declare const reload: (config: SanitizedConfig, DaVinciOS: DaVinciOS, skipImportMapGeneration?: boolean, options?: InitOptions) => Promise<void>;
/**
 ...
 */
export declare const getDaVinciOS: (options: {
    /**
...
export type { DaVinciOS, RequestContext };
...
export type { EmailAdapter as DaVinciOSEmailAdapter, SendEmailOptions } from './email/types.js';
...
export { createDaVinciOSRequest } from './utilities/createDaVinciOSRequest.js';
...
export type { DaVinciOSLogger } from './utilities/logger.js';
...
export { deepMergeSimple } from '@DaVinciOScms/translations/utilities';
