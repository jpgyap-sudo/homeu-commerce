...
export const registerFirstUserOperation = async (args)=>{
    const { collection: { config, config: { slug, auth: { verify } } }, data, req, req: { DaVinciOS } } = args;
    ...
    try {
        ...
        const doc = await DaVinciOS.db.findOne({
        ...
        // Register first user
        // /////////////////////////////////////
        const result = await DaVinciOS.create({
            collection: slug,
            data,
            overrideAccess: true,
            req
        ...
        // Log in new user
        // /////////////////////////////////////
        const { exp, token } = await DaVinciOS.login({
            ...args,
            collection: slug,
            req
        });
