...
export const resetPasswordOperation = async (args)=>{
    const { collection: { config: collectionConfig }, data, depth, overrideAccess, req: { DaVinciOS: { secret }, DaVinciOS }, req } = args;
    ...
    try {
        ...
        user = await DaVinciOS.db.findOne({
        ...
        const doc = await DaVinciOS.db.updateOne({
            id: user.id,
            collection: collectionConfig.slug,
            data: user,
            req
        ...
        const fullUser = await DaVinciOS.findByID({
            id: user.id,
            collection: collectionConfig.slug,
            depth,
            overrideAccess,
