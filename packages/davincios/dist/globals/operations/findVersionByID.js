...
export const findVersionByIDOperation = async (args)=>{
    const { id, currentDepth, depth, disableErrors, globalConfig, overrideAccess, populate, req: { fallbackLocale, locale, DaVinciOS }, req, select: incomingSelect, showHiddenFields } = args;
    try {
        // /////////////////////////////////////
        // Access
        // /////////////////////////////////////
        ...
        const select = sanitizeSelect({
            fields: buildVersionGlobalFields(DaVinciOS.config, globalConfig, true),
        ...
        const { docs: results } = await DaVinciOS.db.findGlobalVersions(findGlobalVersionsArgs);
