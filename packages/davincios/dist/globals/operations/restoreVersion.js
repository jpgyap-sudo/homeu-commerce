...
export const restoreVersionOperation = async (args)=>{
    ...
    try {
        ...
        // /////////////////////////////////////
        const { docs: versionDocs } = await DaVinciOS.db.findGlobalVersions({
        ...
        // fetch previousDoc
        // /////////////////////////////////////
        const previousDoc = await DaVinciOS.findGlobal({
        ...
        // Update global
        // /////////////////////////////////////
        const global = await DaVinciOS.db.findGlobal({
            slug: globalConfig.slug,
            req
        });
        ...
        if (global) {
            ...
            result = await DaVinciOS.db.createGlobalVersion({
                autosave: false,
