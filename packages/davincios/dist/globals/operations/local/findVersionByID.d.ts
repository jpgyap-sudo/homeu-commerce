import type { FindOptions, GlobalSlug, DaVinciOS, RequestContext, TypedLocale } from '../../../index.js';
import type { Document, DaVinciOSRequest, PopulateType, SelectType } from '../../../types/index.js';
...
export declare function findGlobalVersionByIDLocal<TSlug extends GlobalSlug>(DaVinciOS: DaVinciOS, options: Options<TSlug>): Promise<TypeWithVersion<DataFromGlobalSlug<TSlug>>>;
