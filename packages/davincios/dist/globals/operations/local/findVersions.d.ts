...
export declare function findGlobalVersionsLocal<TSlug extends GlobalSlug>(DaVinciOS: DaVinciOS, options: Options<TSlug>): Promise<PaginatedDocs<TypeWithVersion<DataFromGlobalSlug<TSlug>>>>;
