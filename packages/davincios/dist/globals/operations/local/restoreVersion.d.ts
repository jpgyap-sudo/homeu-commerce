import type { GlobalSlug, DaVinciOS, RequestContext, TypedLocale } from '../../../index.js';
import type { Document, DaVinciOSRequest, PopulateType } from '../../../types/index.js';
...
export declare function restoreGlobalVersionLocal<TSlug extends GlobalSlug>(DaVinciOS: DaVinciOS, options: Options<TSlug>): Promise<DataFromGlobalSlug<TSlug>>;
