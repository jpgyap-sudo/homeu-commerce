...
import { type Job, type DaVinciOS, type DaVinciOSRequest, type Sort, type TypedJobs, type Where } from '../index.js';
...
export declare const getJobsLocalAPI: (DaVinciOS: DaVinciOS) => {
    ...
    run: (args?: {
        ...
        overrideAccess?: boolean;
        /**
         * Adjust the job processing order using a DaVinciOS sort string.
         *
