import type { DaVinciOSComponent, SanitizedConfig } from '../../config/types.js';
...
export type AddToImportMap = (DaVinciOSComponent?: DaVinciOSComponent | DaVinciOSComponent[]) => void;
