...
export async function generateTypes(config, options) {
    const logger = getLogger('@davincios/cms', 'sync');
    const outputFile = process.env.DaVinciOS_TS_OUTPUT_PATH || config.typescript.outputFile;
    ...
    const declare = `declare module '@davincios/cms' {\n  export interface GeneratedTypes extends Config {}\n}`;
    const declareWithTSIgnoreError = `declare module '@davincios/cms' {\n  // @ts-ignore \n  export interface GeneratedTypes extends Config {}\n}`;
