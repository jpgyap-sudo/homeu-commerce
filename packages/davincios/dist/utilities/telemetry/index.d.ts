...
export declare const sendEvent: ({ event, DaVinciOS }: Args) => Promise<void>;
export declare const getDaVinciOSVersion: (packageJSON: PackageJSON) => string;
export declare const getLocalizationInfo: (DaVinciOS: DaVinciOS) => Pick<BaseEvent, "locales" | "localizationDefaultLocale" | "localizationEnabled">;
export {};
