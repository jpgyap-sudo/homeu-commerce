...
describe('formatErrors', ()=>{
    it('should format a DaVinciOS ValidationError', ()=>{
    ...
    it('should format a DaVinciOS APIError', ()=>{
    ...
    it('should format a named non-DaVinciOS error', ()=>{
        const err = new Error('Unexpected failure');
        const result = formatErrors(err);
        expect(result.errors).toHaveLength(1);
        expect(result.errors[0].message).toBe('Unexpected failure');
    });
    it('should format a DaVinciOS APIError with no data', ()=>{
