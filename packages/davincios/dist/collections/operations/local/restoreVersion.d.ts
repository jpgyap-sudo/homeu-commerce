...
export declare function restoreVersionLocal<TSlug extends CollectionSlug>(DaVinciOS: DaVinciOS, options: Options<TSlug>): Promise<DataFromCollectionSlug<TSlug>>;
export {};
