...
export declare function findVersionByIDLocal<TSlug extends CollectionSlug>(DaVinciOS: DaVinciOS, options: Options<TSlug>): Promise<TypeWithVersion<DataFromCollectionSlug<TSlug>>>;
export {};
