import type { CollectionSlug, DataFromCollectionSlug, Document, PaginatedDistinctDocs, DaVinciOS, DaVinciOSRequest, PopulateType, RequestContext, Sort, TypedLocale, Where } from '../../../index.js';
...
export declare function findDistinct<TSlug extends CollectionSlug, TField extends keyof DataFromCollectionSlug<TSlug> & string>(DaVinciOS: DaVinciOS, options: Options<TSlug, TField>): Promise<PaginatedDistinctDocs<Record<TField, DataFromCollectionSlug<TSlug>[TField]>>>;
