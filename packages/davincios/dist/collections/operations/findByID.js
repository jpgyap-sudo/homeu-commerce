...
export const findByIDOperation = async (incomingArgs)=>{
    ...
    try {
        ...
        if (req.DaVinciOS.collections[collectionConfig.slug].customIDType) {
        ...
        const docFromDB = await req.DaVinciOS.db.findOne(findOneArgs);
        ...
        if (includeLockStatus && id) {
            ...
            try {
                ...
                const lockedDocument = await req.DaVinciOS.find({
