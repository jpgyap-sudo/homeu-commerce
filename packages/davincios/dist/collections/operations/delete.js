...
export const deleteOperation = async (incomingArgs)=>{
    ...
    try {
        ...
        const { collection: { config: collectionConfig }, depth, overrideAccess, overrideLock, populate, req: { fallbackLocale, locale, DaVinciOS: { config }, DaVinciOS }, req, select: incomingSelect, showHiddenFields, trash = false, where } = args;
        if (!where) {
        ...
        // Retrieve documents
        // /////////////////////////////////////
        const { docs } = await DaVinciOS.db.find({
