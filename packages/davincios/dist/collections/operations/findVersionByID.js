...
export const findVersionByIDOperation = async (args)=>{
    const { id, collection: { config: collectionConfig }, currentDepth, depth, disableErrors, overrideAccess, populate, req: { fallbackLocale, locale, DaVinciOS }, req, select: incomingSelect, showHiddenFields, trash = false } = args;
    if (!id) {
    ...
    try {
        ...
        const select = sanitizeSelect({
            fields: buildVersionCollectionFields(DaVinciOS.config, collectionConfig, true),
        ...
        const versionsQuery = await DaVinciOS.db.findVersions({
