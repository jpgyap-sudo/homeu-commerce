...
export const deleteByIDOperation = async (incomingArgs)=>{
    ...
    try {
        ...
        const { id, collection: { config: collectionConfig }, depth, overrideAccess, overrideLock, populate, req: { fallbackLocale, locale, DaVinciOS: { config }, DaVinciOS }, req, select: incomingSelect, showHiddenFields, trash = false } = args;
        // /////////////////////////////////////
        // Access
        // /////////////////////////////////////
        ...
        const docToDelete = await req.DaVinciOS.db.findOne({
        ...
        // Delete document
        // /////////////////////////////////////
        let result = await req.DaVinciOS.db.deleteOne({
            collection: collectionConfig.slug,
            req,
            select,
            where: {
