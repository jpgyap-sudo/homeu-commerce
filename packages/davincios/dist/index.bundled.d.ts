...
type AuthStrategyFunctionArgs = {
    ...
    DaVinciOS: DaVinciOS;
    /**
     * The AuthStrategy name property from the DaVinciOS config.
     */
    strategyName?: string;
};
...
interface IncomingAuthType {
    ...
    depth?: number;
    /**
     * Advanced - disable DaVinciOS's built-in local auth strategy. Only use this property if you have replaced DaVinciOS's auth mechanisms with your own.
     */
     ...
     * @link https://DaVinciOScms.com/docs/authentication/email#forgot-password
     */
    forgotPassword?: {
        /**
     ...
     *
     * @link https://DaVinciOScms.com/docs/authentication/overview#login-with-username
     */
     ...
     * @link https://DaVinciOScms.com/docs/authentication/custom-strategies
     */
    strategies?: AuthStrategy[];
    /**
     * Controls how many seconds the token will be valid for. Default is 2 hours.
     * @default 7200
     * @link https://DaVinciOScms.com/docs/authentication/overview#config-options
     */
    tokenExpiration?: number;
    /**
     * DaVinciOS Authentication provides for API keys to be set on each user within an Authentication-enabled Collection.
     * @default false
     * @link https://DaVinciOScms.com/docs/authentication/api-keys
     */
    useAPIKey?: boolean;
    /**
     ...
     * @link https://DaVinciOScms.com/docs/authentication/email#email-verification
     */
    verify?: {
...
interface BaseDatabaseAdapter {
     ...
     *
     * @example @DaVinciOScms/db-postgres
     */
    packageName: string;
    /**
     * reference to the instance of DaVinciOS
     */
    DaVinciOS: DaVinciOS;
...
type DraftFlagFromGlobalSlug<TSlug extends GlobalSlug> = GeneratedTypes extends {
    ...
    /**
     * Whether the global should be queried from the versions table/collection or not. [More](https://DaVinciOScms.com/docs/versions/drafts#draft-api)
     */
    draft?: boolean;
} : {
    /**
...
type GlobalAdminOptions = {
    ...
    components?: {
        elements?: {
             ...
             */
            PublishButton?: DaVinciOSComponent<PublishButtonServerProps, PublishButtonClientProps>;
            /**
             ...
             * + drafts must be enabled
             */
            UnpublishButton?: DaVinciOSComponent<UnpublishButtonServerProps, UnpublishButtonClientProps>;
        };
        views?: {
            /**
...
/**
 * Built-in field validations used by DaVinciOS
 *
...
type FieldAccessArgs<TData extends TypeWithID = any, TSiblingData = any> = {
     ...
     */
    id?: number | string;
    /** The `DaVinciOS` object to interface with the DaVinciOS API */
    req: DaVinciOSRequest;
    /**
...
type FilterOptionsProps<TData = any> = {
     ...
     */
    user: Partial<DaVinciOSRequest['user']>;
};
...
type FieldAdmin = {
    className?: string;
    components?: {
        Cell?: DaVinciOSComponent<DefaultServerCellComponentProps, DefaultCellComponentProps>;
        Description?: DaVinciOSComponent<FieldDescriptionServerProps, FieldDescriptionClientProps>;
        Diff?: DaVinciOSComponent<FieldDiffServerProps, FieldDiffClientProps>;
        Field?: DaVinciOSComponent<FieldClientComponent | FieldServerComponent>;
        /**
         * The Filter component has to be a client component
         */
        Filter?: DaVinciOSComponent;
    };
    /**
...
interface FieldBase {
     ...
     * @link https://DaVinciOScms.com/docs/fields/overview#field-names
     */
    name: string;
    required?: boolean;
     ...
     * for [Virtual Fields](https://DaVinciOScms.com/blog/learn-how-virtual-fields-can-help-solve-common-cms-challenges):
...
type UIField = {
    admin: {
        components?: {
             ...
             */
            [key: string]: DaVinciOSComponent | undefined;
...
type SharedUploadProperties = {
     ...
     *
     * {@link https://DaVinciOScms.com/docs/getting-started/concepts#field-level-max-depth}
     */
    maxDepth?: number;
    type: 'upload';
} & ({
...
type Block = {
    ...
    admin?: {
        components?: {
             ...
             */
            Block?: DaVinciOSComponent<any, any>;
            Label?: DaVinciOSComponent<any, any>;
        };
        /** Extension point to add your custom data. Available in server and client. */
        custom?: Record<string, any>;
        /**
...
type JoinField = {
     ...
     *
     * @see https://DaVinciOScms.com/docs/getting-started/concepts#depth
     *
     * @default 1
     */
    maxDepth?: number;
     ...
     *
     * Under the hood, a field with {@link https://DaVinciOScms.com/docs/configuration/collections#fractional-indexing|fractional indexing} is used to optimize inserts and reorderings.
     *
     * @default false
     *
...
type RichTextAdapterBase<Value extends object = object, AdapterProps = any, ExtraFieldProperties = {}> = {
     ...
     *
     * To populate stuff / resolve field hooks, mutate the incoming populationPromises or fieldPromises array. They will then be awaited in the correct order within DaVinciOS itself.
     * @param data
     */
...
type RichTextAdapter<Value extends object = any, AdapterProps = any, ExtraFieldProperties = any> = {
     ...
     */
    CellComponent: DaVinciOSComponent<never>;
    /**
     * Component that will be displayed in the version diff view.
     * If not provided, richtext content will be diffed as JSON.
     */
    DiffComponent?: DaVinciOSComponent<FieldDiffServerProps<RichTextField, RichTextFieldClient>, FieldDiffClientProps<RichTextFieldClient>>;
    /**
     * Component that will be displayed in the edit view.
     */
    FieldComponent: DaVinciOSComponent<RichTextFieldServerProps, RichTextFieldClientProps>;
...
declare const generateDaVinciOSCookie: <T extends GenerateDaVinciOSCookieArgs>({ collectionAuthConfig, cookiePrefix, returnCookieAsObject, token, }: T) => T["returnCookieAsObject"] extends true ? CookieObject : string;
declare const generateExpiredDaVinciOSCookie: <T extends Omit<GenerateDaVinciOSCookieArgs, "token">>({ collectionAuthConfig, cookiePrefix, returnCookieAsObject, }: T) => T["returnCookieAsObject"] extends true ? CookieObject : string;
...
declare const createClientBlocks: ({ blocks, defaultIDType, i18n, importMap, }: {
    blocks: (Block | string)[];
    defaultIDType: DaVinciOS["config"]["db"]["defaultIDType"];
    i18n: I18nClient;
    importMap: ImportMap;
...
type DocumentTabCondition = (args: {
    ...
    /**
     * @deprecated: Use `req.DaVinciOS.config` instead. This will be removed in v4.
     */
    config: SanitizedConfig;
...
type DocumentTabConfig = {
    ...
    readonly Pill?: DaVinciOSComponent;
};
/**
 * @todo: Remove this type as it's only used internally for the config (above)
 */
type DocumentTabComponent = DaVinciOSComponent<{
    path: string;
}>;
 ...
 */
type AdminViewComponent = DaVinciOSComponent<AdminViewServerProps>;
 ...
 */
type EmailAdapter<TSendEmailResponse = unknown> = ({ DaVinciOS }: {
    DaVinciOS: DaVinciOS;
}) => {
...
/**
 * Error names that can be thrown by DaVinciOS during runtime
 */
...
type TaskConfig<TTaskSlugOrInputOutput extends keyof TypedJobs['tasks'] | TaskInputOutput = TaskType> = {
    ...
    /**
     * Define the input field schema - DaVinciOS will generate a type for this schema.
     */
    inputSchema?: Field[];
    /**
    ...
    /**
     * Define the output field schema - DaVinciOS will generate a type for this schema.
     */
    outputSchema?: Field[];
    /**
...
/**
 * Type for data stored in the DaVinciOS-jobs-stats global.
 */
type JobStats = {
    stats?: {
        scheduledRuns?: {
...
type AutorunCronConfig = {
     ...
     *
     * This will not automatically affect user-configured logs (e.g. if you call `console.log` or `DaVinciOS.logger.info` in your job code).
     *
     * @default false
     */
...
type SanitizedJobsConfig = {
    /**
     * If set to `true`, the job system is enabled and a DaVinciOS-jobs collection exists.
    ...
    scheduling?: boolean;
    /**
     * If set to `true`, a DaVinciOS-job-stats global exists.
     * This property is automatically set during sanitization.
     */
    stats?: boolean;
} & JobsConfig;
type JobsConfig = {
     ...
     */
    autoRun?: ((DaVinciOS: DaVinciOS) => MaybePromise<AutorunCronConfig[]>) | AutorunCronConfig[];
    /**
    ...
    /**
     * Adjust the job processing order using a DaVinciOS sort string. This can be set globally or per queue.
     *
     ...
     * use the standard DaVinciOS API for all job operations. This is discouraged, as it will
    ...
    runHooks?: boolean;
    /**
     * A function that will be executed before DaVinciOS picks up jobs which are configured by the `jobs.autorun` function.
     ...
     * @returns boolean
     */
    shouldAutoRun?: (DaVinciOS: DaVinciOS) => MaybePromise<boolean>;
    /**
...
type BeforeScheduleFn = (args: {
    ...
    /**
     * DaVinciOS-job-stats global data
     */
    jobStats: JobStats;
    queueable: Queueable;
    req: DaVinciOSRequest;
...
type AfterScheduleFn = (args: {
    ...
    /**
     * DaVinciOS-job-stats global data. If the global does not exist, it will be null.
     */
 ...
 */
type DaVinciOSComponent<TComponentServerProps extends never | object = Record<string, any>, TComponentClientProps extends never | object = Record<string, any>> = false | RawDaVinciOSComponent<TComponentServerProps, TComponentClientProps> | string;
type RawDaVinciOSComponent<TComponentServerProps extends never | object = Record<string, any>, TComponentClientProps extends never | object = Record<string, any>> = {
    clientProps?: object | TComponentClientProps;
    exportName?: string;
    path: string;
    serverProps?: object | TComponentServerProps;
};
type DaVinciOSComponentProps<TDaVinciOSComponent> = TDaVinciOSComponent extends RawDaVinciOSComponent<infer TComponentServerProps, infer TComponentClientProps> ? TComponentClientProps | TComponentServerProps : never;
type DaVinciOSClientComponentProps<TDaVinciOSComponent> = TDaVinciOSComponent extends RawDaVinciOSComponent<infer _, infer TComponentClientProps> ? TComponentClientProps : never;
type DaVinciOSServerComponentProps<TDaVinciOSComponent> = TDaVinciOSComponent extends RawDaVinciOSComponent<infer TComponentServerProps, infer _> ? TComponentServerProps : never;
type DaVinciOSReactComponent<TDaVinciOSComponent> = React$1.FC<DaVinciOSComponentProps<TDaVinciOSComponent>>;
type DaVinciOSClientReactComponent<TDaVinciOSComponent> = TDaVinciOSComponent extends RawDaVinciOSComponent<infer _, infer TComponentClientProps> ? TComponentClientProps extends never ? never : React$1.FC<TComponentClientProps> : never;
type DaVinciOSServerReactComponent<TDaVinciOSComponent> = TDaVinciOSComponent extends RawDaVinciOSComponent<infer TComponentServerProps, infer _> ? TComponentServerProps extends never ? never : React$1.FC<TComponentServerProps> : never;
...
type LivePreviewConfig = {
     ...
     * DaVinciOS will send a `window.postMessage()` to this URL with the document data in real-time.
     * The frontend application is responsible for receiving the message and updating the UI accordingly.
     * @see https://DaVinciOScms.com/docs/live-preview/frontend
     *
    ...
    url?: ((args: {
        ...
        /**
         * @deprecated
         * Use `req.DaVinciOS` instead. This will be removed in the next major version.
         */
        DaVinciOS: DaVinciOS;
        req: DaVinciOSRequest;
...
type InitOptions = {
    ...
    /**
     * If set to `true`, DaVinciOS will initialize crons for things like autorunning jobs on initialization.
     *
     * @default false
     */
    cron?: boolean;
    ...
    importMap?: ImportMap;
    /**
     * A function that is called immediately following startup that receives the DaVinciOS instance as it's only argument.
     */
    onInit?: (DaVinciOS: DaVinciOS) => Promise<void> | void;
};
/**
 ...
 *
 * @see https://DaVinciOScms.com/docs/access-control/overview
 */
...
/** Web Request/Response model, but the req has more DaVinciOS specific properties added to it. */
type DaVinciOSHandler = (req: DaVinciOSRequest) => Promise<Response> | Response;
/**
 * Docs: https://DaVinciOScms.com/docs/rest-api/overview#custom-endpoints
 */
type Endpoint = {
    ...
    path: string;
    /**
     * Please add "root" routes under the /api folder in the DaVinciOS Project.
...
type DocumentViewComponent = DaVinciOSComponent<DocumentViewServerProps>;
/**
 * @deprecated
 * This type will be renamed in v4.
...
type CustomComponent<TAdditionalProps extends object = Record<string, any>> = DaVinciOSComponent<ServerProps & TAdditionalProps, TAdditionalProps>;
type Locale = {
    /**
...
type BaseLocalizationConfig = {
    ...
    fallback?: boolean;
    /**
     * Define a function to filter the locales made available in DaVinciOS admin UI
     * based on user.
     */
...
/**
 * @see https://DaVinciOScms.com/docs/configuration/localization#localization
 */
 ...
 *
 * @see https://DaVinciOScms.com/docs/configuration/overview
 */
type Config = {
    ...
    admin?: {
         ...
         *
         * @see https://DaVinciOScms.com/docs/custom-components/overview
         */
        components?: {
            /**
         ...
         * To disable the admin panel itself, delete your `/app/(DaVinciOS)/admin` directory.
         * To disable all REST API and GraphQL endpoints, delete your `/app/(DaVinciOS)/api` directory.
        ...
        importMap?: {
            ...
            /**
             * If DaVinciOS cannot find the import map file location automatically,
         ...
         * Live Preview options.
         *
         * @see https://DaVinciOScms.com/docs/live-preview/overview
         */
    ...
    /**
     * Configure authentication-related DaVinciOS-wide settings.
     */
    auth?: {
        /**
         * Define which JWT identification methods you'd like to support for DaVinciOS's local auth strategy, as well as the order that they're retrieved in.
         * Defaults to ['JWT', 'Bearer', 'cookie]
         */
        jwtOrder: ('Bearer' | 'cookie' | 'JWT')[];
    };
    /** Custom DaVinciOS bin scripts can be injected via the config. */
    bin?: BinScriptConfig[];
    blocks?: Block[];
    /**
     ...
     *
     * @see https://DaVinciOScms.com/docs/configuration/collections#collection-configs
     */
    collections?: CollectionConfig[];
    /**
     * Compatibility flags for prior DaVinciOS versions
     */
    compatibility?: {
        /**
         * By default, DaVinciOS will remove the `localized: true` property
         * from fields if a parent field is localized. Set this property
         * to `true` only if you have an existing DaVinciOS database from pre-3.0
    ...
    /**
     * Prefix a string to all cookies that DaVinciOS sets.
     *
     * @default "DaVinciOS"
     */
    cookiePrefix?: string;
    ...
    /** A whitelist array of URLs to allow DaVinciOS cookies to be accepted from as a form of CSRF protection. */
    csrf?: string[];
    /** Extension point to add your custom data. Server only. */
    custom?: Record<string, any>;
     ...
     * Email Adapter
     *
     * @see https://DaVinciOScms.com/docs/email/overview
     */
    ...
    /**
     * @see https://DaVinciOScms.com/docs/configuration/globals#global-configs
     */
    globals?: GlobalConfig[];
    /**
     * Manage the GraphQL API
     *
     * You can add your own GraphQL queries and mutations to DaVinciOS, making use of all the types that DaVinciOS has defined for you.
     *
     * @see https://DaVinciOScms.com/docs/graphql/overview
     */
    graphQL?: {
        disable?: boolean;
        /**
         ...
         *
         * @see https://DaVinciOScms.com/docs/graphql/extending
         */
         ...
         *
         * @see https://DaVinciOScms.com/docs/graphql/overview#custom-validation-rules
         */
        validationRules?: (args: GraphQL.ExecutionArgs) => GraphQL.ValidationRule[];
    };
    /**
     * Tap into DaVinciOS-wide hooks.
     *
     * @see https://DaVinciOScms.com/docs/hooks/overview
     */
    hooks?: {
    ...
    /**
     * Override the log level of errors for DaVinciOS's error handler or disable logging with `false`.
     ...
     */
    maxDepth?: number;
    /** A function that is called immediately following startup that receives the DaVinciOS instance as its only argument. */
    onInit?: (DaVinciOS: DaVinciOS) => Promise<void> | void;
    /**
     * An array of DaVinciOS plugins.
     *
     * @see https://DaVinciOScms.com/docs/plugins/overview
     */
    plugins?: Plugin[];
    /**
     * Allow you to save and share filters, columns, and sort orders for your collections.
     * @see https://DaVinciOScms.com/docs/query-presets/overview
     */
    queryPresets?: {
        /**
         ...
         *
         * DaVinciOS provides sensible defaults (Only Me, Everyone, Specific Users), but you can
         ...
         * ```
         *
         * @see https://DaVinciOScms.com/docs/query-presets/overview#custom-access-control
         */
        constraints: {
         ...
         *
         * @see https://DaVinciOScms.com/docs/query-presets/overview#constraint-access-control
         */
        filterConstraints?: SelectField['filterOptions'];
        labels?: CollectionConfig['labels'];
    };
    /**
     * Control the routing structure that DaVinciOS binds itself to.
     * @link https://DaVinciOScms.com/docs/admin/overview#root-level-routes
     */
    routes?: {
        /**
    ...
    /** Secure string that DaVinciOS will use for any encryption workflows */
    secret: string;
    /**
     ...
     *
     * @see https://DaVinciOScms.com/docs/configuration/overview#options
     */
    serverURL?: string;
    /**
 ...
 * @link https://DaVinciOScms.com/docs/custom-components/document-views#document-root
 */
 ...
 *
 * @link https://DaVinciOScms.com/docs/custom-components/document-views
 */
...
type AddToImportMap = (DaVinciOSComponent?: DaVinciOSComponent | DaVinciOSComponent[]) => void;
...
type DaVinciOSServerAction = (args: {
    [key: string]: any;
    action: Action;
    i18n: I18nClient;
...
type RenderedField = {
     ...
     * Please use `fieldIsSidebar(field)` from `DaVinciOS` instead.
...
/**
 * FileSizeImproved is a more precise type, and will replace FileSize in DaVinciOS v4.
...
type ImageSize = {
     ...
     *
     * NOTE: In DaVinciOS v4, these options (`disableGroupBy`, `disableListColumn` and `disableListFilter`)
...
type UploadConfig = {
     ...
     * (like DaVinciOS-prefixed cookies) to prevent leaking session information to external
     * services. By default, DaVinciOS automatically filters out DaVinciOS-prefixed cookies
     ...
     * @default undefined
     */
    handlers?: ((req: DaVinciOSRequest, args: {
        doc: TypeWithID;
        headers?: Headers;
        params: {
...
type DraftFlagFromCollectionSlug<TSlug extends CollectionSlug> = GeneratedTypes extends {
    ...
    /**
     * Whether the document(s) should be queried from the versions table/collection or not. [More](https://DaVinciOScms.com/docs/versions/drafts#draft-api)
     */
    draft?: boolean;
} : {
    /**
...
type CollectionAdminOptions = {
    ...
    components?: {
        ...
        views?: {
             ...
             * @link https://DaVinciOScms.com/docs/custom-components/custom-views
             * @example
             * ```ts
             * views: {
             *   grid: {
             ...
             * @link https://DaVinciOScms.com/docs/custom-components/list-view
             */
            list?: {
                actions?: CustomComponent[];
                Component?: DaVinciOSComponent;
    ...
    /**
     * Performance opt-in. If true, will use the [Select API](https://DaVinciOScms.com/docs/queries/select) when
     ...
     * Uses `DaVinciOS.findDistinct` under the hood to populate the group-by options.
     *
...
type CollectionConfig<TSlug extends CollectionSlug = any> = {
    ...
    /**
     * Hooks to modify DaVinciOS functionality
     */
    hooks?: {
...
type CustomDaVinciOSRequestProperties = {
    context: RequestContext;
    ...
    locale?: 'all' | TypedLocale;
    /**
     * The DaVinciOS object
     */
    DaVinciOS: typeof initialized;
    /**
     * The context in which the request is being made
     */
    DaVinciOSAPI: 'GraphQL' | 'local' | 'REST';
    /** Optimized document loader */
    DaVinciOSDataLoader: {
        /**
         * Wraps `DaVinciOS.find` with a cache to deduplicate requests
         ...
         * const result = await req.DaVinciOSDataLoader.find({
         *  collection,
         *  req,
         *  where: findWhere,
         * })
    ...
    DaVinciOSUploadSizes?: Record<string, Buffer>;
...
type DaVinciOSRequestData = {
    /**
     * Data from the request body
     *
     * Within DaVinciOS operations, i.e. hooks, data will be there
...
interface DaVinciOSRequest extends CustomDaVinciOSRequestProperties, Partial<Request>, DaVinciOSRequestData {
    headers: Request['headers'];
}
...
declare const incrementLoginAttempts: ({ collection, DaVinciOS, user, }: Args$j) => Promise<void>;
...
declare const resetLoginAttempts: ({ collection, doc, DaVinciOS, req, }: Args$i) => Promise<void>;
...
declare const getDataLoader: (req: DaVinciOSRequest) => {
    find: DaVinciOS["find"];
...
declare function getLocalizedPaths({ collectionSlug, fields, globalSlug, incomingPath, locale, overrideAccess, parentIsLocalized, DaVinciOS, }: {
    collectionSlug?: string;
    fields: FlattenedField$1[];
    globalSlug?: string;
    incomingPath: string;
 ...
 * - `migrationDir` argument from DaVinciOS config
 * - `src/migrations`
 * - `dist/migrations`
 * - `migrations`
 *
 ...
 */
declare function getMigrations({ DaVinciOS, }: {
    DaVinciOS: DaVinciOS;
}): Promise<{
 ...
 * 1. @DaVinciOScms/db-* packages: Loads from adapter's predefinedMigrations folder directly (no package.json export needed)
 *    Example: `--file @DaVinciOScms/db-mongodb/relationships-v2-v3`
 * 2. Any other package/path: Uses dynamic import via package.json exports or absolute file paths
 *    Example: `--file @DaVinciOScms/plugin-seo/someMigration` or `--file /absolute/path/to/migration.ts`
 */
declare const getPredefinedMigration: ({ dirname, file, migrationName: migrationNameArg, DaVinciOS, }: {
    dirname: string;
    file?: string;
    migrationName?: string;
    DaVinciOS: DaVinciOS;
 ...
 */
declare const readMigrationFiles: ({ DaVinciOS, }: {
    DaVinciOS: DaVinciOS;
}) => Promise<Migration[]>;
...
/**
 * Validate the DaVinciOS key / value / operator
 */
...
declare const getFileByPath: (filePath: string) => Promise<DaVinciOSRequest["file"]>;
 ...
 */
declare function addLocalesToRequestFromData(req: DaVinciOSRequest): void;
 ...
 * b. match the `config.admin.user` property on the DaVinciOS config
...
/**
 * This is used for generating the TypeScript types (DaVinciOS-types.ts) with the DaVinciOS generate:types command.
 */
...
declare const createDaVinciOSRequest: ({ canSetHeaders, config: configPromise, params, DaVinciOSInstanceCacheKey, request, }: Args$6) => Promise<DaVinciOSRequest>;
 ...
 * ```
 */
declare const handleEndpoints: ({ basePath, config: incomingConfig, path, DaVinciOSInstanceCacheKey, request, }: {
    basePath?: string;
    config: Promise<SanitizedConfig> | SanitizedConfig;
...
declare function parseDocumentID({ id, collectionSlug, DaVinciOS }: ParseDocumentIDArgs): string | number | undefined;
...
declare const deleteCollectionVersions: ({ id, slug, DaVinciOS, req }: Args$4) => Promise<void>;
...
declare const enforceMaxVersions: ({ id, collection, global: globalConfig, max, DaVinciOS, req, }: Args$3) => Promise<void>;
...
declare const getLatestCollectionVersion: <T extends TypeWithID = any>({ id, config, DaVinciOS, published, query, req, }: Args$2) => Promise<T | undefined>;
...
declare const getLatestGlobalVersion: ({ slug, config, locale, DaVinciOS, published, req, where, }: Args$1) => Promise<{
    global: Document;
...
/**
 * Shape constraint for DaVinciOSTypes.
 ...
 * DaVinciOSTypes merges GeneratedTypes with these fallbacks.
 */
interface UntypedDaVinciOSTypes {
    auth: {
        [slug: string]: {
            forgotPassword: {
                email: string;
...
/**
 * Interface to be module-augmented by the `DaVinciOS-types.ts` file.
 * When augmented, its properties take precedence over UntypedDaVinciOSTypes.
 */
...
/**
 * DaVinciOSTypes merges GeneratedTypes with UntypedDaVinciOSTypes.
 * - When augmented: uses augmented properties, fills gaps with untyped fallbacks
 * - When not augmented: uses only UntypedDaVinciOSTypes
 */
type DaVinciOSTypes = IsAugmented extends true ? GeneratedTypes & Omit<UntypedDaVinciOSTypes, keyof GeneratedTypes> : UntypedDaVinciOSTypes;
type TypedCollection<T extends DaVinciOSTypesShape = DaVinciOSTypes> = T['collections'];
type TypedBlock = DaVinciOSTypes['blocks'];
type TypedWidget<T extends DaVinciOSTypesShape = DaVinciOSTypes> = T extends {
    widgets: infer TWidgets;
} ? TWidgets extends Record<string, unknown> ? TWidgets : Record<string, unknown> : Record<string, unknown>;
type TypedUploadCollection<T extends DaVinciOSTypesShape = DaVinciOSTypes> = NonNever<{
    [TSlug in keyof T['collections']]: 'filename' | 'filesize' | 'mimeType' | 'url' extends keyof T['collections'][TSlug] ? T['collections'][TSlug] : never;
}>;
type TypedCollectionSelect<T extends DaVinciOSTypesShape = DaVinciOSTypes> = T['collectionsSelect'];
type TypedCollectionJoins<T extends DaVinciOSTypesShape = DaVinciOSTypes> = T['collectionsJoins'];
type TypedGlobal<T extends DaVinciOSTypesShape = DaVinciOSTypes> = T['globals'];
type TypedGlobalSelect<T extends DaVinciOSTypesShape = DaVinciOSTypes> = T['globalsSelect'];
type StringKeyOf<T> = Extract<keyof T, string>;
type CollectionSlug<T extends DaVinciOSTypesShape = DaVinciOSTypes> = StringKeyOf<T['collections']>;
type BlockSlug = StringKeyOf<TypedBlock>;
type WidgetSlug<T extends DaVinciOSTypesShape = DaVinciOSTypes> = StringKeyOf<TypedWidget<T>>;
type DataFromWidgetSlug<TSlug extends WidgetSlug> = TypedWidget[TSlug] extends {
    data?: infer TData;
} ? TData : TypedWidget[TSlug];
type UploadCollectionSlug<T extends DaVinciOSTypesShape = DaVinciOSTypes> = StringKeyOf<TypedUploadCollection<T>>;
type DefaultDocumentIDType = DaVinciOSTypes['db']['defaultIDType'];
type GlobalSlug<T extends DaVinciOSTypesShape = DaVinciOSTypes> = StringKeyOf<T['globals']>;
type TypedLocale<T extends DaVinciOSTypesShape = DaVinciOSTypes> = T['locale'];
type TypedFallbackLocale = DaVinciOSTypes['fallbackLocale'];
/**
 *
 ...
 */
type TypedUser = DaVinciOSTypes['user'];
type TypedAuthOperations<T extends DaVinciOSTypesShape = DaVinciOSTypes> = T['auth'];
type AuthCollectionSlug<T extends DaVinciOSTypesShape = DaVinciOSTypes> = StringKeyOf<T['auth']>;
type TypedJobs = DaVinciOSTypes['jobs'];
type HasDaVinciOSJobsType = GeneratedTypes extends {
    collections: infer C;
} ? 'DaVinciOS-jobs' extends keyof C ? true : false : false;
/**
 * Represents a job in the `DaVinciOS-jobs` collection, referencing a queued workflow or task (= Job).
 * If a generated type for the `DaVinciOS-jobs` collection is not available, falls back to the BaseJob type.
 *
 * `input` and `taksStatus` are always present here, as the job afterRead hook will always populate them.
 */
type Job<TWorkflowSlugOrInput extends false | keyof TypedJobs['workflows'] | object = false> = HasDaVinciOSJobsType extends true ? {
    input: BaseJob<TWorkflowSlugOrInput>['input'];
    taskStatus: BaseJob<TWorkflowSlugOrInput>['taskStatus'];
} & Omit<TypedCollection['DaVinciOS-jobs'], 'input' | 'taskStatus'> : BaseJob<TWorkflowSlugOrInput>;
/**
 * @description DaVinciOS
 */
declare class BaseDaVinciOS {
    /**
    ...
    /**
     * @description Initializes DaVinciOS
     * @param options
     */
    init(options: InitOptions): Promise<DaVinciOS>;
...
declare const initialized: BaseDaVinciOS;

declare const reload: (config: SanitizedConfig, DaVinciOS: DaVinciOS, skipImportMapGeneration?: boolean, options?: InitOptions) => Promise<void>;
/**
 * Get a DaVinciOS instance.
 * This function is a wrapper around new BaseDaVinciOS().init() that adds the following functionality on top of that:
 *
 * - smartly caches DaVinciOS instance on the module scope. That way, we prevent unnecessarily initializing DaVinciOS over and over again
 * when calling getDaVinciOS multiple times or from multiple locations.
 * - adds HMR support and reloads the DaVinciOS instance when the config changes.
 */
declare const getDaVinciOS: (options: {
    /**
     * A unique key to identify the DaVinciOS instance. You can pass your own key if you want to cache this DaVinciOS instance separately.
     * This is useful if you pass a different DaVinciOS config for each instance.
     *
     * @default 'default'
     */
    key?: string;
} & InitOptions) => Promise<DaVinciOS>;
type DaVinciOS = BaseDaVinciOS;
