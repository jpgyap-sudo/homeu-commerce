...
import type { Block, ClientField, DataFromWidgetSlug, DefaultDocumentIDType, Field, FlattenedBlock, JobsConfig, KVAdapterResult, DaVinciOS, RegisteredPlugins, RequestContext, SelectField, TypedUser, TypedWidget, WidgetSlug } from '../index.js';
...
import type { DaVinciOSLogger } from '../utilities/logger.js';
/**
 ...
 */
export type DaVinciOSComponent<TComponentServerProps extends never | object = Record<string, any>, TComponentClientProps extends never | object = Record<string, any>> = false | RawDaVinciOSComponent<TComponentServerProps, TComponentClientProps> | string;
export type RawDaVinciOSComponent<TComponentServerProps extends never | object = Record<string, any>, TComponentClientProps extends never | object = Record<string, any>> = {
    clientProps?: object | TComponentClientProps;
    exportName?: string;
    path: string;
    serverProps?: object | TComponentServerProps;
};
export type DaVinciOSComponentProps<TDaVinciOSComponent> = TDaVinciOSComponent extends RawDaVinciOSComponent<infer TComponentServerProps, infer TComponentClientProps> ? TComponentClientProps | TComponentServerProps : never;
export type DaVinciOSClientComponentProps<TDaVinciOSComponent> = TDaVinciOSComponent extends RawDaVinciOSComponent<infer _, infer TComponentClientProps> ? TComponentClientProps : never;
export type DaVinciOSServerComponentProps<TDaVinciOSComponent> = TDaVinciOSComponent extends RawDaVinciOSComponent<infer TComponentServerProps, infer _> ? TComponentServerProps : never;
export type DaVinciOSReactComponent<TDaVinciOSComponent> = React.FC<DaVinciOSComponentProps<TDaVinciOSComponent>>;
export type DaVinciOSClientReactComponent<TDaVinciOSComponent> = TDaVinciOSComponent extends RawDaVinciOSComponent<infer _, infer TComponentClientProps> ? TComponentClientProps extends never ? never : React.FC<TComponentClientProps> : never;
export type DaVinciOSServerReactComponent<TDaVinciOSComponent> = TDaVinciOSComponent extends RawDaVinciOSComponent<infer TComponentServerProps, infer _> ? TComponentServerProps extends never ? never : React.FC<TComponentServerProps> : never;
...
export type DaVinciOSHandler = (req: DaVinciOSRequest) => Promise<Response> | Response;
/**
...
export type DocumentViewComponent = DaVinciOSComponent<DocumentViewServerProps>;
/**
 * @deprecated
 * This type will be renamed in v4.
...
export type CustomComponent<TAdditionalProps extends object = Record<string, any>> = DaVinciOSComponent<ServerProps & TAdditionalProps, TAdditionalProps>;
export type Locale = {
    /**
