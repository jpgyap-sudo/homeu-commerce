...
import type { CollectionSlug, DataFromGlobalSlug, GlobalSlug, DaVinciOS, RequestContext, TypedCollectionJoins, TypedCollectionSelect, TypedFallbackLocale, TypedLocale, TypedUser } from '../index.js';
import type { File } from '../uploads/types.js';
import type { Operator } from './constants.js';
export type { DaVinciOS } from '../index.js';
export type CustomDaVinciOSRequestProperties = {
...
export interface DaVinciOSRequest extends CustomDaVinciOSRequestProperties, Partial<Request>, DaVinciOSRequestData {
