import type { AcceptedLanguages, I18nClient } from '@DaVinciOScms/translations';
 ...
 * This type is only used for the DaVinciOS Config. Use `PreviewButtonClientProps` instead.
 */
...
export type DaVinciOSServerAction = (args: {
    [key: string]: any;
    action: Action;
    i18n: I18nClient;
