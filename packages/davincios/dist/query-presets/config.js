...
export const queryPresetsCollectionSlug = 'DaVinciOS-query-presets';
export const getQueryPresetsConfig = (config)=>({
        ...
        fields: [
            ...
            getConstraints(config),
            {
                ...
                admin: {
                    components: {
                        Cell: '@davincios/next/client#QueryPresetsWhereCell',
                        Field: '@davincios/next/client#QueryPresetsWhereField'
                    }
                },
                hooks: {
                    beforeValidate: [
            ...
            },
            {
                ...
                admin: {
                    components: {
                        Cell: '@davincios/next/client#QueryPresetsColumnsCell',
                        Field: '@davincios/next/client#QueryPresetsColumnField'
                    }
                },
                validate: (value)=>{
                    if (value) {
            ...
            },
            {
                ...
                admin: {
                    components: {
                        Cell: '@davincios/next/client#QueryPresetsGroupByCell',
                        Field: '@davincios/next/client#QueryPresetsGroupByField'
                    }
                },
                label: 'Group By'
            },
