export const downSQL: "  // Test predefined migration DOWN from DaVinciOS package\n  DaVinciOS.logger.info('Test migration DOWN from DaVinciOS package executed')";
/**
 * Test predefined migration for testing plugin-style module specifier imports.
 * This is used in integration tests to verify that external packages (without @DaVinciOScms/db-* prefix)
...
export const upSQL: "  // Test predefined migration from DaVinciOS/__testing__/predefinedMigration\n  DaVinciOS.logger.info('Test migration UP from DaVinciOS package executed')";
