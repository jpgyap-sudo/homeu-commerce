...
describe('getSafeFileName', ()=>{
    ...
    it('should keep incrementing until unique name is found', async ()=>{
        mockDocWithFilenameExists.mockResolvedValueOnce(true).mockResolvedValueOnce(true).mockResolvedValueOnce(true).mockResolvedValueOnce(false);
        mockFileExists.mockResolvedValue(false);
        const result = await getSafeFileName({
            collectionSlug: 'media',
            desiredFilename: 'photo.jpg',
    ...
    it('should handle conflicts from both database and filesystem', async ()=>{
        mockDocWithFilenameExists.mockResolvedValueOnce(true).mockResolvedValueOnce(false).mockResolvedValueOnce(false);
        mockFileExists.mockResolvedValueOnce(true).mockResolvedValueOnce(false);
        const result = await getSafeFileName({
            collectionSlug: 'media',
            desiredFilename: 'photo.jpg',
...
//# sourceMappingURL=getSafeFilename.spec.js.map