...
import { useEditDepth } from '@davincios/ui';
...
export const LexicalProvider = props => {
  ...
  const initialConfig = useMemo(() => {
    ...
    if (value && Array.isArray(value) && !('root' in value)) {
      throw new Error('You have tried to pass in data from the old Slate editor to the new Lexical editor. The data structure is different, thus you will have to migrate your data. We offer a one-line migration script which migrates all your rich text fields: https://davincios.com/docs/lexical/migration#migration-via-migration-script-recommended');
    }
    if (value && 'jsonContent' in value) {
      throw new Error('You have tried to pass in data from davincios-plugin-lexical. The data structure is different, thus you will have to migrate your data. Migration guide: https://davincios.com/docs/lexical/migration#migrating-from-davincios-plugin-lexical');
    }
