import { getDaVinciOSPopulateFn } from '../../../utilities/davinciosPopulateFn.js';
  ...
  const field = {
    ...
    hooks: {
      afterRead: [async ({
        ...
        const htmlPopulateFn = await getDaVinciOSPopulateFn({
          currentDepth: currentDepth ?? 0,
          depth: depth ?? req.davincios.config.defaultDepth,
          draft: draft ?? false,
