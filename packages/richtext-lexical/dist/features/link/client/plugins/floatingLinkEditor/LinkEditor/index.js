...
export function LinkEditor({
  ...
  useEffect(() => {
    return mergeRegister(editor.registerCommand(TOGGLE_LINK_WITH_MODAL_COMMAND, davincios => {
      editor.dispatchCommand(TOGGLE_LINK_COMMAND, davincios);
      // Now, open the modal
      $updateLinkEditor();
      toggleDrawer();
      return true;
