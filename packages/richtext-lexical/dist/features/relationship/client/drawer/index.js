...
import { toast } from '@davincios/ui';
...
const RelationshipDrawerComponent = t0 => {
  ...
  if ($[3] !== editor || $[4] !== openListDrawer) {
    t3 = () => editor.registerCommand(INSERT_RELATIONSHIP_WITH_DRAWER_COMMAND, davincios => {
      setReplaceNodeKey(davincios?.replace ? davincios?.replace.nodeKey : null);
      openListDrawer();
      return true;
