...
import { useBulkUpload, useEffectEvent, useModal } from '@davincios/ui';
  ...
  if ($[14] !== editor || $[15] !== openBulkUpload) {
    t5 = () => {
      ...
      return mergeRegister(editor.registerNodeTransform(UploadNode, node_1 => {
        ...
        upload();
      }), editor.registerCommand(INSERT_UPLOAD_COMMAND, davincios => {
        editor.update(() => {
          ...
          if ($isRangeSelection(selection)) {
            const uploadNode = $createUploadNode({
              data: {
                ...
                relationTo: davincios.relationTo,
                value: davincios.value
              }
            });
            const {
              focus
