    ...
    admin: {
      components: {
        Block: {
          ...
          path: '@davincios/richtext-lexical/client#CodeBlockBlockComponent'
        }
      },
      jsx: '@davincios/richtext-lexical/client#codeConverterClient'
    },
    fields: [{
      name: 'language',
      type: 'select',
      ...
      admin: {
        components: {
          Field: {
            clientProps: args,
            path: '@davincios/richtext-lexical/client#CodeComponent'
          }
        }
      },
      label: ''
