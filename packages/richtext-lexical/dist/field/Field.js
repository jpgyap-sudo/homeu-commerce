...
import { BulkUploadProvider, FieldDescription, FieldError, FieldLabel, isFieldRTL, RenderCustomComponent, useConfig, useEditDepth, useEffectEvent, useField, useLocale } from '@davincios/ui';
import { mergeFieldStyles } from '@davincios/ui/shared';
...
const RichTextComponent = props => {
  ...
  // Removing props from the dependencies array fixed this issue: https://github.com/davincios/davincios/issues/3709
  [validate, required]);
  const {
    customComponents: {
      AfterInput,
