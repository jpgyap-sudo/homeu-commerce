...
;
    ...
    return {
      CellComponent: '@davincios/richtext-lexical/rsc#RscEntryLexicalCell',
      DiffComponent: '@davincios/richtext-lexical/rsc#LexicalDiffComponent',
      editorConfig: finalSanitizedEditorConfig,
      features,
      FieldComponent: {
        path: '@davincios/richtext-lexical/rsc#RscEntryLexicalField',
        serverProps: {
          admin: args?.admin,
          views: args?.views
        }
