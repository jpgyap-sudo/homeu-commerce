...
// dist/withDaVinciOS/withDaVinciOS.js
var withDaVinciOS_exports = {};
__export(withDaVinciOS_exports, {
  default: () => withDaVinciOS_default,
  withDaVinciOS: () => withDaVinciOS
});
module.exports = __toCommonJS(withDaVinciOS_exports);

// dist/withDaVinciOS/withDaVinciOS.utils.js
...
function getNextjsVersion() {
  try {
    ...
    console.error("DaVinciOS: Error getting Next.js version", e);
    return void 0;
  }
}
...
// dist/withDaVinciOS/withDaVinciOSLegacy.js
var withDaVinciOSLegacy = (nextConfig = {}) => {
  if (process.env.DAVINCIOS_PATCH_TURBOPACK_WARNINGS !== "false") {
    ...
    console.warn = (...args) => {
      ...
      if (hasTurbopackConfigWarning) {
        consoleWarn(...args);
        consoleWarn('DaVinciOS: You can safely ignore the "Invalid next.config" warning above. This only occurs on Next.js 15.2.x or lower. We recommend upgrading to the latest supported Next.js version to resolve this warning.');
        return;
      }
      consoleWarn(...args);
    };
  ...
  if (isBuild && (isTurbopackNextjs15 || isTurbopackNextjs16)) {
    throw new Error("DaVinciOS: Your Next.js version does not support using Turbopack for production builds. The *minimum* Next.js version required for Turbopack Builds is 16.1.0. Please upgrade to the latest supported Next.js version to resolve this error.");
  }
  const toReturn = {
    ...nextConfig,
...
var poweredByHeader = {
  key: "X-Powered-By",
  value: "Next.js, DaVinciOS"
};
var withDaVinciOS = (nextConfig = {}, options = {}) => {
  ...
  if (nextConfig.experimental?.staleTimes?.dynamic) {
    console.warn("DaVinciOS: detected a non-zero value for the `staleTimes.dynamic` option in your Next.js config. This will slow down page transitions and may cause stale data to load within the Admin panel. To clear this warning, remove the `staleTimes.dynamic` option from your Next.js config or set it to 0. In the future, Next.js may support scoping this option to specific routes.");
    env.NEXT_PUBLIC_ENABLE_ROUTER_CACHE_REFRESH = "true";
  }
  if (nextConfig.cacheComponents) {
    env.DAVINCIOS_CACHE_COMPONENTS_ENABLED = "true";
  }
  if (nextjsVersion?.major === 16 && !hasServerFastRefreshConfigOption) {
    console.warn("DaVinciOS: You are using an unsupported Next.js 16 version. You can find the supported Next.js versions here: https://davincios.com/docs/getting-started/installation");
  }
  const consoleWarn = console.warn;
  ...
  const baseConfig = {
    ...
    sassOptions: {
      ...
      * SassWarning: Deprecation Warning on line 8, column 8 of file:///Users/alessio/Documents/GitHub/ davincios/packages/ui/src/scss/styles.scss:8:8:
    ...
    serverExternalPackages: [
      ...
      ...process.env.NODE_ENV === "development" && options.devBundleServerPackages !== true ? (
        /**
        * Unless explicitly disabled by the user, by passing `devBundleServerPackages: true` to withDaVinciOS, we
        ...
        *
        * Example:
        * - @davincios/richtext-lexical (in bundle) -> installs qs-esm (bundled because of importer)
        * - davincios (not in bundle, external) -> installs qs-esm (external because of importer)
      ...
      return {
        ...
        resolve: {
          ...
          fallback: {
            ...
            /*
            * This fixes the following warning when running next build with webpack (tested on Next.js 16.0.3 with DaVinciOS 3.64.0):
            *
            ...
            * ./node_modules/.pnpm/@davincios+db-mongodb@3.64.0_payload@3.64.0_graphql@16.12.0_typescript@5.7.3_/node_modules/@davincios/db-mongodb/dist/index.js
            * ./src/davincios.config.ts
  ...
  if (!supportsTurbopackBuild) {
    return withDaVinciOSLegacy(baseConfig);
  } else {
    return {
      ...baseConfig,
      serverExternalPackages: [
...
var withDaVinciOS_default = withDaVinciOS;
// Annotate the CommonJS export names for ESM import in node:
0 && (module.exports = {
  withDaVinciOS
});
//# sourceMappingURL=withDaVinciOS.cjs.map
