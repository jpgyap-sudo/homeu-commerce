...
export const renderDocument = async ({
  ...
  getPreferences(collectionSlug ? `collection-${collectionSlug}` : `global-${globalSlug}`, davincios, req.user.id, req.user.collection)]);
...
export async function DocumentView(props) {
  try {
    ...
    logError({
      err: error,
      davincios: props.initPageResult.req.davincios
    });
