...
export const fetchVersion = async ({
  ...
  try {
    if (collectionSlug) {
      return await req.davincios.findVersionByID({
        id: String(id),
      ...
      return await req.davincios.findGlobalVersionByID({
        id: String(id),
        slug: globalSlug,
        depth,
        locale,
...
export const fetchVersions = async ({
  ...
  try {
    if (collectionSlug) {
      ...
      return await req.davincios.findVersions({
        collection: collectionSlug,
        depth,
        draft,
        limit,
      ...
      return await req.davincios.findGlobalVersions({
        slug: globalSlug,
        depth,
        limit,
        locale,
...
export const fetchLatestVersion = async ({
  ...
  const entityConfig = collectionSlug ? req.davincios.collections[collectionSlug]?.config : globalSlug ? req.davincios.globals[globalSlug]?.config : undefined;
