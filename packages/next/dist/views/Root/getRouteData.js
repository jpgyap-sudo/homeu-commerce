...
export const getRouteData = ({
    ...
    case 1:
      {
        ...
        if (customView?.view?.davinciosComponent || customView?.view?.Component) {
      ...
      if (segmentTwo === 'verify') {
        ...
        if (segmentThree === 'trash' && typeof segmentFour === 'string') {
          ...
          if (config.folders && segmentThree === config.folders.slug && collectionConfig.folders) {
            ...
            if (customCollectionView.viewKey && customCollectionView.view.davinciosComponent) {
  ...
  if (globalConfig && routeParams.versionID) {
    routeParams.versionID = davincios.db.defaultIDType === 'number' && isNumber(routeParams.versionID) ? Number(routeParams.versionID) : routeParams.versionID;
  }
