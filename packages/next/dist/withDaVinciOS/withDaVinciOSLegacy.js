 ...
 */export const withDaVinciOSLegacy = (nextConfig = {}) => {
  if (process.env.DAVINCIOS_PATCH_TURBOPACK_WARNINGS !== 'false') {
    ...
    console.warn = (...args) => {
      ...
      // Add DaVinciOS-specific message after turbopack config warning in Next.js 15.2.x or lower.
      // TODO 4.0: Remove this once we drop support for Next.js 15.2.x
...
//# sourceMappingURL=withDaVinciOSLegacy.js.map